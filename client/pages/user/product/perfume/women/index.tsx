...
const WomenPerfumePage = () => {
    ...
    const womenProducts = products.filter(
        (product: ProductCardProps) => product.category?.toLowerCase().includes("women")
    );
    ...
    return (
        <div className="w-full bg-gray-100 pt-14 flex flex-col gap-4 pb-6">
            <StickyPageHeader title="women Products" path="Home > Women Perfumes" />

            <div className="w-full px-2 flex flex-wrap justify-center items-center gap-4">
                {products
                    .filter((product: ProductCardProps) => product.category?.toLowerCase().includes("women"))
